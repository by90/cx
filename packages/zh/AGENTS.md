...
2. **全面注释**：所有新增或修改的代码都必须有代码文件级说明、类说明、函数说明和逐行业务代码说明；只有空行、纯格式行或重复结构行可以不写相邻说明注释。
...
13. 新增或修改代码时，代码文件、类、函数和每一行业务代码都必须写面向初学者的相近说明注释；代码文件必须有文件级说明，类和函数必须有职责说明，默认逐行解释代码意图，除非该行是纯格式、空行或重复结构。
