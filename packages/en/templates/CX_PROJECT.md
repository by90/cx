...
- State, lifecycle, invariants, and domain collaboration use full OOP or equivalent type modeling.
...
- Common packages include package-local `readme.md` files that explain public APIs and usage.
